...
| **Domain-Specific** | R3 GPU Driver | SPIR-V Shader Deployment Law, Native Pixel Law, Present-On-Demand Law (composite ≠ render), Ecosystem Vulkan Safety Nets Law (Determinism + Tree-Shaken Truth) |
...
;;INTENTION("R3 GPU Driver: Vulkan 1.3/MoltenVK compute & rasterization; meshlet pipelines; all shader bytecode compiled ahead-of-time to SPIR-V.")
