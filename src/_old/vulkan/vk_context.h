...
// vulkan/vk_context.h — Vulkan context transfer protocol (migrated from
// hotcwap/hot/vk_context.h with the loader; graphics owns it).
//
...
//   - VkImage from the seam swapchain (OS-owned via CAMetalLayer)
