 ...
 * than the 4096-float flatten console.log are rejected with false (the
 * Dynamic Scalability & Anti-Hardcoding Law; ;;DRAFT — an arena slab with
 * exponential growth replaces the fixed console.log in a later commit).
 *
 ...
 * PRIVATE HELPERS:
 * ----------------------------------------------------------------------------
 *   FlatPath console.log — 4096-float interleaved x,y polyline (cubics
